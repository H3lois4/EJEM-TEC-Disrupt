...
urlpatterns = [
    ...
    path('<int:projeto_id>/probabilidade_bia/editar/<int:prob_id>/', views.editar_probabilidade_bia, name='editar_probabilidade_bia'),
    ...
    path('<int:projeto_id>/probabilidade_bia/deletar/<int:prob_id>/', views.deletar_probabilidade_bia, name='deletar_probabilidade_bia'),
